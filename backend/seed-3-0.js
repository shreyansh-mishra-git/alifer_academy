  ...
  try {
    ...
    const brahmastraData = {
      ...
      videos: [
        ...
        { title: 'L-6-Unit-5-Part-6-DENM-NA-CH-2-Topic-2-Newton Gregory Backward Difference Interpolation Formula', videoId: 'TmsusLaGv98', duration: '1:22:11 min', isFree: true, isLocked: false, order: 6 },
        ...
        { title: 'L-11-Unit-5-Part-11-DENM-NA-CH-4-Topic-2-Gauss Forward Interpolation Formula', videoId: 'cYh5wpUTwaY', duration: '44:20 min', isFree: true, isLocked: false, order: 11 },
        { title: 'L-12-Unit-5-Part-1-DENM-NA-CH-4-Topic-3-Gauss Backward Interpolation Formula', videoId: 'e5uP6Q-hP7s', duration: '44:30 min', isFree: true, isLocked: false, order: 12 },
      ],
      pdfs: [
